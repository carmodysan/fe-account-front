<template>
    <v-select :value="value" @change="select" :items="items" label="Choisissez une année" />
</template>
...
export default {
    ...
    created: function() {
        ...
        if (month == 11) { // Si nous sommes en décembre, alors on proposera l'année à venir en plus.
